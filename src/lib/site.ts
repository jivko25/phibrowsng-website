...
export const faqs = [
  {
    ...
    answer:
      "Обадете се на посочения телефон, пишете във Viber (💜) или използвайте контактната форма в долната част на страницата.",
  },
  {
    question: "Колко време отнема микроблейдингът?",
    answer:
      "Първата процедура обикновено отнема между 2 и 3 часа, включително консултация и избор на форма и цвят.",
  },
  {
    question: "Има ли нужда от корекция?",
    answer:
      "Да, препоръчва се корекция след 4–6 седмици за перфектен и дълготраен резултат.",
  },
  {
